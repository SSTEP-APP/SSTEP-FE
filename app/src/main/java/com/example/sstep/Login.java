...
//                    String password = json.getString("password");
        ...
        sighIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), JoinActivity.class); //메인페이지로
        ...
        searchId.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), Find_id.class); //메인페이지로
                startActivity(intent);
                finish();
            }
        });
        ...
        searchPass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    Intent intent = new Intent(getApplicationContext(), Find_password.class); //메인페이지로
                    startActivity(intent);
                    finish();
            }
        });

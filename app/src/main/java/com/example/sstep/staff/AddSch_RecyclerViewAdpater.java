...
public class AddSch_RecyclerViewAdpater extends RecyclerView.Adapter<AddSch_RecyclerViewAdpater.ViewHolder> {
    ...
    public AddSch_RecyclerViewAdpater(ArrayList<Staff_infoInput_recyclerViewItem> mList) {
        this.mList = mList;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.addsch_recycle_item, parent, false);

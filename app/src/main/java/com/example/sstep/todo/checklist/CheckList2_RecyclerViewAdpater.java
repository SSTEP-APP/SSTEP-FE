...
public class CheckList2_RecyclerViewAdpater extends RecyclerView.Adapter<CheckList2_RecyclerViewAdpater.Holder> {
    private Context context;
    private List<CheckList2_recyclerViewWordItemData> list = new ArrayList<>();
    public CheckList2_RecyclerViewAdpater(Context context, List<CheckList2_recyclerViewWordItemData> list) {

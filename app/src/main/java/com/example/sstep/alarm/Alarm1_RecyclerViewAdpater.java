...
public class Alarm1_RecyclerViewAdpater extends RecyclerView.Adapter<Alarm1_RecyclerViewAdpater.Holder> {
    private Context context;
    private List<Alarm1_recyclerViewWordItemData> list = new ArrayList<>();

    // 어댑터 생성자
    public Alarm1_RecyclerViewAdpater(Context context, List<Alarm1_recyclerViewWordItemData> list) {

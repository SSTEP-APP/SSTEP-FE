...
public class Alarm3_RecyclerViewAdpater extends RecyclerView.Adapter<Alarm3_RecyclerViewAdpater.Holder> {
    private Context context;
    private List<Alarm3_recyclerViewWordItemData> list = new ArrayList<>();

    // 어댑터 생성자
    public Alarm3_RecyclerViewAdpater(Context context, List<Alarm3_recyclerViewWordItemData> list) {

...
public interface CommuteApiService {
    ...
    @POST("/commute/{staffId}/{commuteId}/update-dispute")
    Call<Void> updateDisputeCommute(@Path("staffId") Long staffId, @Path("commuteId") Long commuteId, @Body CommuteRequestDto commuteRequestDto);

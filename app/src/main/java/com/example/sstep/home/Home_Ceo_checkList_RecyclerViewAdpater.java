...
public class Home_Ceo_checkList_RecyclerViewAdpater extends RecyclerView.Adapter<Home_Ceo_checkList_RecyclerViewAdpater.ViewHolder> {
    ...
    private List<Home_Ceo_checkList_recyclerViewItem> mList = null;

    public Home_Ceo_checkList_RecyclerViewAdpater(List<Home_Ceo_checkList_recyclerViewItem> mList) {
        this.mList = mList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Home_Ceo_checkList_recyclerViewItem item = mList.get(position);

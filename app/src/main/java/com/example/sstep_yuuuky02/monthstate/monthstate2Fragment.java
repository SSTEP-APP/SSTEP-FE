package com.example.sstep_yuuuky02.monthstate;
...
public class monthstate2Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // list dialog 띄우기
        LinearLayout monthstate2_fragment_L1 = v.findViewById(R.id.monthstate2_fragment_L1);
        ...
        monthstate2_fragment_L1.setOnClickListener(new View.OnClickListener() {
            @Override
